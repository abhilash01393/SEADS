...
public class Service {
    ...
    public static Chromosome getFittest(Population population) {
    	List<Chromosome> populace = population.getPopulace();
        double maxFit = Integer.MIN_VALUE;
        int maxFitIndex = 0;
        for (int i = 0; i < populace.size(); i++) {
            if (maxFit <= populace.get(i).getFitness()) {
                maxFit = populace.get(i).getFitness();
                maxFitIndex = i;
            }
        }
        ;
        return populace.get(maxFitIndex);
    }
    ...
    public static Population nonDominatedPopulationSort(Population population) {
        ...
        //--TO-DO--
//    	String binaryString = "";
//        for (Chromosome ch : population.getPopulace())
//        {
...
//        System.out.print(binaryString);
    ...
    public static String decodeGeneticCodeToBinary(final Allele[] geneticCode) {
