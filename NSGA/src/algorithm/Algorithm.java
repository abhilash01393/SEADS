...
import api.GraphPlot;
import api.Reporter;
import api.Service;
import api.Synthesis;
import configuration.Configuration;
import datastructure.Allele;
...
public class Algorithm {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println("Running what you need");
        ...
        System.out.println("GENERATION : 1" + "\tFITTEST:" + Service.getFittest(parent).getFitness());
        for(Chromosome ch : parent.getPopulace())
        {
        	System.out.println("Chromosome :" + Service.decodeGeneticCodeToBinary(ch.getGeneticCode()) + "\tFitness:" + ch.getFitness());
        }
...
//            System.out.println("Ranked Front:");
//            System.out.println(Arrays.asList(rankedFronts));
...
//                String binaryString = "";
//                for (Chromosome ch : singularFront)
//                {
//                	for(Allele bit : ch.getGeneticCode()) binaryString += bit.getGene() ? "1" : "0";
//                		binaryString += "\t" + ch.getFitness() + "\n";
//                		
//                }
...
//            {
//            	//System.out.print("ff");
//            	List<Chromosome> cc = parent.getPopulace();
//            	Allele[] geneticCode = cc.get(a).getGeneticCode();
//            	int x =-1;
//            	for (int b = 0;b<5;b++)
//            		if(geneticCode[b].getGene())
//            			x = 1;
//            		else
//            			x = 0;
//            	System.out.print(x);
//            }
            System.out.println("GENERATION : " + i + "\tFITTEST:" + Service.getFittest(child).getFitness());
            for(Chromosome ch : child.getPopulace())
            {
            	System.out.println("Chromosome :" + Service.decodeGeneticCodeToBinary(ch.getGeneticCode()) + "\tFitness:" + ch.getFitness());
            }
